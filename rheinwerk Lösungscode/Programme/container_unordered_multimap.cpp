...
int main()
{
   ...
   unordered_multimap<int,string> mi{{35,"Italien"},{65,"Polen"},{45,"Schweden"}};
   unordered_multimap<int,string> mk{{85,"Belgien"},{35,"Slowenien"}};
   mi.merge(mk);
   cout << "merge():    ";
   ausgeben(mi);
   cout << "merge():    ";
   ...
   unordered_multimap md{pair{25, "Spanien"}, {15, "Irland"}, {25, "Schweiz"}};
   cout << "Anzahl:     ";
   cout << md.size() << endl;
}
